...
- **修改密码**：学生和教师可自行修改登录密码
- **教师权限限制**：教师对学生管理仅有查看和新增权限，教室/课程/课次/选课仅可查看
...
- **选课管理**：学生选课记录维护
- **考勤管理**：签到记录查看、状态编辑，列表展示课程名称和学生姓名
- **打卡签到**：学生登录后查看今日课次，一键签到；课次开始后方可签到，0~10 分钟正常，10~20 分钟迟到，超 20 分钟不可签到
- **考勤统计**：按学生维度统计出勤率；支持按课程查看所有选课学生的考勤详情；超 20 分钟未签到自动置为缺勤
- **CSV 导出**：管理员可导出任意课程考勤记录，教师仅可导出自己教授课程的记录
...
4. 系统比较签到时间与课次时间：
   ...
   - ≤10 分钟 → `NORMAL`（正常）
   - 10~20 分钟 → `LATE`（迟到）
   - >20 分钟 → 不可签到，自动置为 `ABSENT`（缺勤）
5. 学生可在"考勤统计"查看个人出勤率；教师/管理员可按课程查看所有学生考勤详情
